...
​	一般的神经网络是由输入值和激活函数给出感知器最终的输出。如图1-1所示：

![neural-network-1-1](/Users/kevin/Code/python/project/udacity-ML-2/p7/dogs-vs-cats/neural-network-1-1.png)	输入值可以是由权重、输入和偏置项的线性函数组成，如**Sigmoid函数** ：
